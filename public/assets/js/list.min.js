...
},{"mongodb-querystring":41,"vue":50,"vue-hot-reload-api":48}],2:[function(require,module,exports){
...
},{"./facet.vue":1,"./metric.vue":3,"./tableau.vue":4,"vue":50,"vue-resource":49}],3:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7c8b6f7f", module.exports)
  } else {
    hotAPI.update("_v-7c8b6f7f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"mongodb-querystring":41,"vue":50,"vue-hot-reload-api":48,"vueify/lib/insert-css":51}],4:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
...
exports.default = {
	...
	methods: {
		reload: function reload(done) {
			...
			var url = window.location.protocol.concat('//').concat(window.location.host).concat('/corpus.jsonad?').concat(_mongodbQuerystring2.default.stringify(qry, {}));
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-b2a8147a", module.exports)
  } else {
    hotAPI.update("_v-b2a8147a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/object/keys":5,"mongodb-querystring":41,"vue":50,"vue-hot-reload-api":48,"vueify/lib/insert-css":51}],5:[function(require,module,exports){
...
},{"./lib/mqs.js":42}],42:[function(require,module,exports){
'use strict';
var qs = require('qs')
...
},{"qs":43,"traverse":47}],43:[function(require,module,exports){
'use strict';
